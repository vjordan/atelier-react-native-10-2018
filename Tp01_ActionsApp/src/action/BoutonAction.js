 ...
 *
 */
const BoutonAction = ({nom, actionBouton, etatTerminer}) => (
    <TouchableHighlight
        underlayColor='#efefef'
        style={styles.bouton}
        onPress={() => actionBouton()}>
        <Text style={[styles.texte, nom=="Supprimer" ? styles.supprimer : (etatTerminer==true ? styles.termine : styles.texte)]}>
            {nom}
        </Text>
    </TouchableHighlight>
)
